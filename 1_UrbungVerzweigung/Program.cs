...
switch (auswahl)
{
    case 1:
        ...
        Console.WriteLine("{0} C° sind {1} Klevin", celsius, kelvin);
        break;
    ...
    case 3:
        ...
        double klevin1 = Convert.ToDouble(Console.ReadLine());
        double celsius2 = (klevin1 - 273.15);
        Console.WriteLine("{0} Klevin sind {1} C°", klevin1, celsius2);
        break;
    case 4:
        Console.Write("Gib die Zahl in Celsius an:");
